...
class Case(Base):
    ...
    # 状态信息
    status = Column(String(50), default="新案", comment="状态: 新案/撰写中/待质检/已定稿/待递交/已递交-在审/答复OA/授权/驳回/放弃/结案归档")
